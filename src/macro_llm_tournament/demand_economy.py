...
from .demand_timeline import (
    DEFAULT_PERIODS_PER_YEAR,
    INFLATION_TARGET,
    NEUTRAL_POLICY_RATE,
    PROTECTED_PERIOD_OVERRIDE_FIELDS,  # noqa: F401 - public compatibility re-export
    ...
    _months_per_period,
    _next_environment,
    _normalize_initial_environment_override,
    _normalize_period_overrides,
    _per_period_amount,
    _period_state,
    _quarterly_flow_for_frequency,
    _quarterly_persistence_for_frequency,
    _validated_periods_per_year,
    validate_timeline_scenario,
)
...
def run_demand_economy(
    ...
    *,
    ...
    for scenario in scenarios:
        validate_timeline_scenario(scenario)
